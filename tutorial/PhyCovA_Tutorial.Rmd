...
<https://evolcompvir-kuleuven.shinyapps.io/PhyCovA/>

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgevolcompvir_start_up.png)

## Docker image

The 2nd method is to download ("pull") the docker image available on
dockerhub. Installing docker will not be part of this tutorial but good tutorials are available from: <https://docs.docker.com/engine/install/>
...
<https://hub.docker.com/repository/docker/timblokker/phycova> :

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgPull_Docker.png)
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgPulled_Docker.png)

Next the docker image is available on your machine, you can check this by running:

**`docker images`**

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgDocker_Images.png)
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgDocker_Run.png)

Finally, the browser can be pointed to <http://localhost:3838/> 

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgDocker_Started.png)

# PhyCovA

PhyCovA can correlate transition counts or rates obtained from either
trees already annotated with ancestral state information or reconstruct and annotate the ancestral states before correlating the variables.
...
Diclaro, J. W., Duraffour, S., Elmore, M. J., ... Rambaut, A. (2017).
...
The already annotated mode requires only 2 files, the phylogeny, here we will use an MCC tree for the ebola data set and at least 1 distance matrix. The data can be obtained from github:
<https://github.com/TimBlokker/PhyCovA/tree/master/input/ebola> . The annotations in the tree must **exactly** match the column names in the pairwise distance matrices. And the phylogeny needs to be rooted.

At first we upload the 2 documents using the file-upload panels, by
clicking **"Browse..."**, this will open a file explorer and should be intuitive to use. **Note:** For the distance matrix multiple files can be selected in the file explorer, while the "Tree File" file upload only allows 1 file.
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgAnnotated_before_run.png)

When selecting "Yes, I took care of this!" then PhyCovA will start
searching for annotations in the tree file that match the column namesof the distance matrix.

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgAnnotation%20label%20notfoun%20yet.png)

Once an annotation was found that matches the column names in the
distance matrix, PhyCovA will inform the user.

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgAnnotation_PopUp.png)
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgSelectedColumn_Found.png)
...
Immediately after clicking the input fields will appear but depending on the size of the tree and the number of distance matrices, the analysis might take a few seconds to 30 seconds.

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgLoading_Run.png)

After the covariate analysis has been finished the scatterplot is
visible. At first we see a scatterplot of a binary variable which is not very informative, so we change the predictor to "greatCircleDistances".

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgchangePredictor.png)
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgRegression_line.png)

Then we can look at the residuals of linear regression:

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgResiduals.png)
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgtoggle_points.png)
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgWarningLog.png)
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgWarning.png)
...
been observed in the tree. Then the transition events can be colourized grouped by the origin location ("from") or also destination ("to").

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgcolourFrom.png)

Lastly, PhyCovA also offers the option to summarize the transition
counts by state in a bar diagram. Also here we can group observation by origin country or destination country. The option to include
0-transitions has no effect here (because we add 0...).

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgUNi_Bar.png)

For this univariate case the standardization and the inclusion of the
0-transitions have impact on the regression output. And this is shown and updated upon changing the input and is shown as depicted below:

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgUnivariate_Regression.png)
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgMultivariate_tab.png)
...
variable is available as response (drop-down menu in the top left corner,
here for the TreeTime reconstructions also the transition rate will be available).

![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgVariable_Selection.png)
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgGueckedou.png)
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgnodenumber.png)
...
something else, one opens the "Univariate" tab and clicks "RESET". Now all input is cleared and new files can be uploaded.
...
![](/home/tim/Documents/PhyCovA/PhyCovA/tutorial/tutorial_imgNon_annotated.png)
